...
from cs336_basics.training.utils import cross_entropy_loss, cosine_lr_schedule, gradient_clipping, get_batch, save_checkpoint, load_checkpoint
...
def run_rope(
    ...
    output = rope_layer.forward(in_query_or_key, token_positions)
    return output
